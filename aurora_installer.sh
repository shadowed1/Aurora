...
echo "${MAGENTA}${BOLD}"
echo ""
echo "   ------    ${RESET}${MAGENTA}----    ----${RESET}${MAGENTA}${BOLD} -----------    --------   -----------     ------${RESET}"    
echo "${MAGENTA}${BOLD}  ********   ****    **** ***********   **********  ${RESET}${MAGENTA}***********${RESET}${MAGENTA}${BOLD}    ********${RESET}"   
echo "${MAGENTA} ----------  ----    ---- ----    ---  ----    ---- ----    ${RESET}${BLUE}---   ----------${RESET}" 
echo "${MAGENTA}****    **** ****    ${RESET}${BLUE}**** *********${RESET}${MAGENTA}    ***      *** *********    ****    ****${RESET}" 
echo "${BLUE}------------${RESET}${MAGENTA} ----    ----${RESET}${BLUE} ---------    ---      --- ${RESET}${MAGENTA}---------${RESET}${BLUE}    ------------${RESET}" 
echo "${BLUE}************ ************ ****  ****   ****    **** ****  ****   ************${RESET}" 
echo "${CYAN}----    ---- ------------ ----   ----   ----------  ----   ----  ----    ----${RESET}" 
